...
struct Evolution {
    ...
    int stop_time_cell_num = 0;

		Evolution() : driver_adv(0), mutation_rate(0), driver_mutation_rate(0),
		              stop_time_cell_num(0) {};

		Evolution(float driver_adv_ex, float mutation_rate_ex,
							float driver_mutation_rate_ex, int stop_time_cell_num_ex):
