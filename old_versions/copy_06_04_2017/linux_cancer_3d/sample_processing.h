...
class ProbeMutProcessor {
  ...
  friend float tree_dist(const ProbeMutProcessor &,
                         const ProbeMutProcessor &);
  friend float tree_dist_degree_vs_mean_pass(const ProbeMutProcessor &,
                                               const ProbeMutProcessor &);

  // additional functions for tree metrics
  friend float my_chi_square_depth(const ProbeMutProcessor &,
                                   const ProbeMutProcessor &);
  friend float my_chi_square_degree(const ProbeMutProcessor &,
                                    const ProbeMutProcessor &);
  friend float mean_pass_to_cell_dist(const ProbeMutProcessor &,
                                      const ProbeMutProcessor &);
protected:
  /////////////////////////////////////////////////////////////////////////////
  //Support functions for file writing
  void SaveProbeCells(char *);
